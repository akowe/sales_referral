	...
	<main>
		<div class="container-fluid">
			...
			<div class="d-sm-flex align-items-center justify-content-between mb-4">
				<h4 class=" text-gray-800"> <?php if($this->session->userdata('user_type')==='support'):?>Dashboard
						<span class="text-primary">>>></span> Welcome <span class="text-primary"><?php echo $this->session->userdata('fname');?></span> <?php endif;?> </h4>
				<?php echo
				"";
				?>
			</div>
