	...
	<main>
		<div class="container-fluid">
			...
			<div class="d-sm-flex align-items-center justify-content-between mb-4">
				<h1 class="h3 mb-0 text-gray-800"> <?php if($this->session->userdata('user_type')==='finance'):?>Dashboard <span class="text-primary">>>></span> Welcome <span class="text-primary"><?php echo $this->session->userdata('fname');?></span> <?php endif;?> </h1>
				<?php echo
				"";
				?>
			</div>
